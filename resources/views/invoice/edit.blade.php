                    ...
                    <div class="card-body"> -->
                        ...
                        <!-- <div class="row">
                            ...
                            <!--     <div class="text-center">
                                    <center><img src="{{ asset('images/user.png') }}" alt="" width="110px" height="50px"></center><hr>
                                </div> -->
                            </div>
                            <div class="col-md-6">
                                <table>
                                    <tr>
                                        <td rowspan="9"><img src="{{ asset('images/anonim.jpg') }}" alt="" width="110px" height="50px">&nbsp;&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <td colspan="3" align="center">
                                                    <button class="btn btn-success btn-sm"><i class="menu-icon icon-plus"></i>Tambah</button>
                                                </td>
                                            </tr>
                                        </tfoot>
                                        <!-- FORM UNTUK MEMILIH PRODUK YANG AKAN DITAMBAHKAN -->
